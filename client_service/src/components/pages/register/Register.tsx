    ...
    <>
      ...
      <div className="center-page-lr">
        <div className="form-container">
          ...
          <div className="form-group1 animated-toggle">
          ...
          {accountType === 'Prani Experts' && (
            <>
              {/* Role Selection */}
              <div className="form-group1 creative-role-grid">
                {roles.map((role) => (
                  <div
                    key={role}
              ...
              <div className="form-grid">
                ...
                <div className={showPasswordRules ? 'form-group1' : 'form-group1 form-grp'}>
                  <input
                  ...
                  <IconButton
                    ...
                    style={{ position: "relative", right: "-18rem", top: "-3rem" }}
                  >
              ...
              <div className="form-grid">
                ...
                <div className="form-group1">
                  ...
                  <IconButton
                    ...
                    onClick={() => setShowPassword((s) => !s)}
                    onMouseDown={(e) => e.preventDefault()}
                    style={{ position: "absolute", right: "2rem", top: "16rem", transform: "translateY(-50%)" }}
                  >
                    {showPassword ? <VisibilityOffOutlinedIcon /> : <RemoveRedEyeOutlinedIcon />}
                  </IconButton>
