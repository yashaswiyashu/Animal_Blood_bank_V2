...
const AdminDashboard: React.FC = () => {
  ...
  const handleUpdateUser = async (e: React.FormEvent) => {
    ...
    try {
      ...
      //     farmer_password: editFormData.password,
      //   }
      //   : {
      ...
      //     user_password: editFormData.password,
      //   };

      const payload = (isFarmer && editFormData.password.trim() !== "")
        ? {
          farmer_name: editFormData.name,
          farmer_phone: editFormData.phone,
          farmer_city: editFormData.city,
        ...
        : isFarmer ? {
          ...
          farmer_country: editFormData.country,
          farmer_pin_code: editFormData.pin_code,
        } : (!isFarmer && editFormData.password.trim() !== "") ?{
          user_name: editFormData.name,
          user_email: editFormData.email,
          user_phone: editFormData.phone,
          city: editFormData.city,
  ...
  const handleDoctorSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if(doctorFormData.user_password !== ""){
    ...
    <div className="center-page">
      <div className="dashboard-header">
        ...
        <div className={`nav-buttons ${isMenuOpen ? 'show' : ''}`}>
          ...
          <button
            className={`${isMenuOpen ? 'form-button2' : 'form-button1'}`}
            ...
            <form onSubmit={handleAddUser}>
              ...
              <div className="form-group">
                ...
                <IconButton
                  ...
                  style={newUserForm.role !== "farmer"? { position: "relative", top: "-2rem", left: "27rem", transform: "translateY(-50%)" } : { position: "relative", top: "-2rem", left: "27rem", transform: "translateY(-50%)" }}
                >
            ...
            <form onSubmit={handleUpdateUser}>
              ...
              <div className="form-group">
                ...
                <IconButton
                  ...
                  onClick={() => setShowPassword((s) => !s)}
                  onMouseDown={(e) => e.preventDefault()}
                  style={newUserForm.role !== "farmer"? { position: "relative", top: "-2rem", left: "27rem", transform: "translateY(-50%)" } : { position: "relative", top: "19rem", left: "57rem", transform: "translateY(-50%)" }}
                >
                  {showPassword ? <VisibilityOffOutlinedIcon /> : <RemoveRedEyeOutlinedIcon />}
                </IconButton>
              </div>
